...
wFORMS.behaviors.validation.messages = {
	...
	isAlpha 		: "Slo se admiten letras (a-z A-Z). No se permiten nmeros.",
	isEmail 		: "No es una direccin de correo vlida.",
	isInteger 		: "Introduzca un valor numrico.",
	isFloat 		: "Introduzca un valor decimal (ej: 1.9) .",
	isAlphanum 		: "nicamente caracteres alfanumricos (a-z 0-9).",
	isDate 			: "La fecha no es correcta",
	isCustom		: "",
	notification	: "Se ha(n) encontrado %% error(es). El formulario no se ha enviado.\nVerifique los datos introducidos."
}

wFORMS.behaviors.repeat.MESSAGES = {
	ADD_CAPTION 	: "Aadir una fila",
	ADD_TITLE 		: "Repite el campo o grupo anterior.",
	REMOVE_CAPTION 	: "Eliminar",
	REMOVE_TITLE 	: "Borra el campo o grupo anterior."	
}

wFORMS.behaviors.paging.MESSAGES = {
	CAPTION_NEXT 	 : 'Pgina siguiente',
	CAPTION_PREVIOUS : 'Pgina anterior'
}
