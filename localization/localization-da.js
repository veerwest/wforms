...
wFORMS.behaviors.validation.messages = {
	...
	isAlpha 		: "Teksten må kun indeholde bogstaver (a-z, A-Z). Numre er ikke tilladt.",
	isEmail 		: "Dette lader ikke til at være en gyldig email adresse.",
	isInteger 		: "Venligst tast et heltal.",
	isFloat 		: "Venligst tast et tal. Anvend punktum som kommaseparator. (F.eks. 1.9)",
	isAlphanum 		: "Brug venligst kun bogstaver eller tal (a-z, 0-9).",
	isDate 			: "Dette lader ikke til at være en gyldig dato. (F.eks. 2006-12-24 for 24. dec 2006)",
	isCustom		: "",
	notification	: "Der opstod %% fejl. Din formular er ikke afsendt.\nVenligst undersøg at alle informationer er korrekt udfyldt."
}

wFORMS.behaviors.repeat.MESSAGES = {
	ADD_CAPTION 	: "Tilføj endnu et svar ",
	ADD_TITLE 		: "",
