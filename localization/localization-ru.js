...
wFORMS.behaviors.validation.messages = {
	...
	isAlpha 		: "В этом поле должны находиться только буквы (а-я, А-Я). Цифры не допустимы. ",
	isEmail 		: "Неправильный формат адреса.",
	isInteger 		: "Пожалуйста введите целое число.",
	isFloat 		: "Пожалуйста введите дробное число (например, 1.9).",
	isAlphanum 		: "Пожалуйста используйте только цифро-буквенные символы [а-я 0-9].",
	isCustom		: "",
	notification	: "Данные формы не были отправлены.\nПожалуйста проверьте введённую информацию.\n(Ошибок: %%) "
}
...
wFORMS.behaviors.paging.MESSAGES = {
	CAPTION_NEXT 	 : 'Следующая страница',
	CAPTION_PREVIOUS : 'Следующая страница'
}
